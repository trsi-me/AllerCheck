(function () {
    ...
    var STRINGS = {
        en: {
            ...
            'about.modelIntro': 'The allergen detection model is built from scratch and trained on real datasets in the dataset/ folder:',
            'about.ds1': 'food_ingredients_and_allergens.csv — food products with ingredients and allergen labels',
            'about.ds2': 'allergies_10k.csv — 10,000+ ingredient samples with allergen annotations',
        ...
        ar: {
            ...
            'about.modelIntro': 'نُبنى نموذج الكشف عن مسببات الحساسية من الصفر ويُدرَّب على مجموعات حقيقية في مجلد dataset/:',
            'about.ds1': 'food_ingredients_and_allergens.csv — منتجات غذائية مع مكونات وتسميات حساسية',
            'about.ds2': 'allergies_10k.csv — أكثر من 10 آلاف عينة مكونات مع تعليقات حساسية',
